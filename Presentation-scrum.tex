...
\begin{frame}
    ...
    \begin{block}
        \onslide<1-> Scum is one of the most used agile method.
        \begin{center}
            \onslide<2-> Empiricism \onslide<2-> - Participation \onslide<2-> - Self-organization
        \end{center}
    ...
    \begin{block}
        \onslide<3-> Scrum can be broken down into
        
        \begin{center}
            \onslide<4-> Roles \onslide<4-> - Events \onslide<4-> - Artifacts
        \end{center}
    \end{block}
